    ...
    <main className="min-h-screen bg-background pt-24 pb-16">
      <div className="container-narrow">
        ...
        <div className="space-y-10 text-text-body font-light leading-relaxed text-justify-clean">
          ...
          <section>
            <h2 className="font-serif text-xl text-foreground mb-4">
              6. Besondere Hinweise für Beratungs- und Coaching-Leistungen
            </h2>
            <p className="mb-4">
            ...
            <p className="mb-4">
              Diese Daten werden streng vertraulich behandelt und nur zum Zweck der Durchführung der vereinbarten Beratungs- oder Coaching-Leistung verwendet. Die Rechtsgrundlage für diese Verarbeitung ist Art. 6 Abs. 1 lit. b DSGVO (Vertragserfüllung).
            </p>
            <p>
              Beratungs- und Coaching-Unterlagen werden für die Dauer der Zusammenarbeit und darüber hinaus für einen Zeitraum von 10 Jahren aufbewahrt, sofern keine kürzeren Aufbewahrungsfristen vereinbart wurden.
            </p>
          </section>
